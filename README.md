...
主线没有自动播放或强制倒计时。42秒只是连续推进时的典型节奏，用户可以随时暂停、返回、跳过或进入档案索引。
...
| Idea | 迁徙思想 | 随想、灵感与未完成计划 | 已实现分支预览 |
| Memory | 人类记忆库 | 影像、经历与人生片段 | 已实现分支预览 |
